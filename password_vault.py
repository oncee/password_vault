...
def create_password_vault():
  ...
  print("To create a new password vault, you will need to set up a 24-word seed phrase and a passphrase.")
...
def login_to_password_vault():
  # Prompt the user to enter the seed phrase and passphrase
  print("Enter your seed phrase and passphrase to access the password vault:")
  ...
  if password == stored_password:
    ...
    print("Access denied. Incorrect seed phrase or passphrase.")
...
def get_password(website, username):
  ...
  with open("password_vault.txt", "r") as
